...
public interface IHandler {
    ...
    default BotApiMethodMessage handle(RequestCommand requestCommand) {
        SendMessage message = new SendMessage();
        message.setChatId(requestCommand.getChatId());
        message.setText("Пока фича не работает(");
        return message;
    }
    default BotApiMethodMessage handle(RequestMessage requestMessage) {
        SendMessage message = new SendMessage();
    ...
    default BotApiMethodMessage handle(ARequest request) {
